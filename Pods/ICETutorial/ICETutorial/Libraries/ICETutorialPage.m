...
- (void)setTitleStyle:(ICETutorialLabelStyle *)style {
    ...
    [self.title setLinesNumber:style.linesNumber];
    [self.title setOffset:style.offset];
}
...
- (void)setSubTitleStyle:(ICETutorialLabelStyle *)style {
    ...
    [self.subTitle setLinesNumber:style.linesNumber];
    [self.subTitle setOffset:style.offset];
}
